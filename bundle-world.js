...
// ESTRUCTURA DE LA ESCENA 8TH WALL (Despiezada y comentada)
const i = {
  "objects": {
    ...
    "492cfe2c-9334-4a9c-a48a-be80132af9fb": {
      ...
      "light": {
        ...
        "shadowRadius": 2,
        "followCamera": false,
        // === AQUÍ CONTROLAS EL ÁREA Y NÍTIDEZ DE LA SOMBRA ===
        "shadowCamera": [-0.5, 0.5, 0.5, -0.5, 0.5, 200]
      },
    ...
    "52ba8a86-a459-4df8-b954-a570e85e0484": {
      ...
      // === AQUÍ CONTROLAS LA ALTURA INICIAL DE LA CÁMARA PARA LA ESCALA ===
      "position": [0, 0.22, 3.211226375221431],
  ...
  "runtimeVersion": { "type": "version", "level": "major", "major": 2, "minor": 0, "patch": 0 }
};
    delete i.history;
